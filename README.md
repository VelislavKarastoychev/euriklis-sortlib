...
- In version 1.1.7 the error message corresponded to the non number array input in the bucket_sort method was correctly declared and connected with the main method (The file corresponded to this error was not declared in the index file of the errors).
