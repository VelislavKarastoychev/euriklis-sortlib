...
In version 1.1.9 the method find_element_in_sorted_object_array_by_property() and the method remove_element_from_sorted_/object_array() was set to return empty output when the array is empty without additional tests and throwing of error messages. 
